          ...
          <div>
            ...
            <p class="text-xs opacity-70 leading-snug">
              {{
                ...
                'Export Vibepollo-Linux, Playnite, plugin, and display-helper logs.'
              }}
            </p>
          </div>
          ...
          <div>
            ...
            <p class="text-xs opacity-70 leading-snug">
              {{
                ...
                'Download logs and the most recent Vibepollo-Linux crash dump for issue reports.'
              }}
            </p>
          </div>
          <n-button
...
const logSourceOptions = computed(() => {
  const options = [
    { label: translate('troubleshooting.logs_source_sunshine', 'Vibepollo-Linux'), value: 'sunshine' },
  ];
